 ...
 * @author RyuujiMD
 */
public class RptTardanzaConsolidado extends javax.swing.JInternalFrame {
...
//        FormularioUtil.modeloSpinnerFechaHora(spFechaFin, "dd/MM/yyyy");
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("REPORTE CONSOLIDADO DE TARDANZAS");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(RptTardanzaConsolidado.class.getName()).log(Level.SEVERE, null, ex);
...
//        FormularioUtil.activarComponente(btnOficina, radGrupo.isSelected());
    ...
    private void imprimir() throws IOException, DocumentException {
        ...
        }else if (radPorFecha.isSelected()) {
            rangoTitulo = "ENTRE: ";
...
//        bandera = true;
        //Prueba de reporte 
        rptTardCx reporteTardanza = new rptTardCx();
        String grupoOficina = "";
        String tipo = "";
        if(oficinaSeleccionada!=null){
        ...
        reporteTardanza.crearPdf("ReporteTardanza.pdf", dnis, fechaInicio, fechaFin, grupoOficina, tipo, usuario);
    }
