...
import vistas.reportes.procesos.rptCompensacion;

/**
 *
 * @author Aldo
 */
public class RptCompensacion extends javax.swing.JInternalFrame {
...
//        FormularioUtil.modeloSpinnerFechaHora(spFechaFin, "dd/MM/yyyy");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setMaximizable(true);
        setTitle("REPORTE DE COMPENSACION");
...
//        
        ...
        rptCompensacion rptTard = new rptCompensacion();
        if(oficinaSeleccionada!=null){
            rptTard.crearPdf("RptCompensacion "+oficinaSeleccionada.getNombre().split(" ", 0)[0]+fechaImpreso+".pdf", dnis, fechaInicio, fechaFin, grupoOficina, tipo, usuario, departamentoId);
        }else{
            rptTard.crearPdf("RptCompensacion"+"Personal"+fechaImpreso+".pdf", dnis, fechaInicio, fechaFin, grupoOficina, tipo, usuario,departamentoId);
        }
